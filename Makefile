...
lint-py:  ## lint python with ruff
	python -m ruff check polars_fsspec
	python -m ruff format --check polars_fsspec
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix polars_fsspec
	python -m ruff format polars_fsspec
...
test:  ## run python tests
	python -m pytest -v polars_fsspec/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v polars_fsspec/tests --cov=polars_fsspec --cov-report term-missing --cov-report xml
